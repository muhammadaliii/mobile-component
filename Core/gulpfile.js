    ...
    js:
        {
            prodJs:
                [
                    path.join(__dirname, targetPath + "/assets/js/vendor.min.js"),
                    path.join(__dirname, targetPath + "/assets/js/plugins.min.js"),
                    path.join(__dirname, targetPath + "/assets/js/app.min.js"),
                ],
            vendor:
                [
            ...
            plugins:
                [
                    ...
                    path.join(__dirname, "bower_components/jquery-browser/jquery.browser.js"),
...
gulp.task('js_prod', function () {
    return gulp.src(paths.js.prodJs)
        .pipe(concat('js-prod.min.js'))
        .pipe(uglifyjs())
        .pipe(gulp.dest(path.join(__dirname, targetPath + '/assets/js/')));
});
...
gulp.task('production', ['css_prod', 'js_prod']);
